class Parameters():
    ...
    def parse_args(self):
        ...
        parser.add_argument('--enc_hid', default=self.encoder_hidden, help='encoder state size', dest='enc_hid')
        parser.add_argument('--dec_hid', default=self.decoder_hidden, help='decoder state size', dest='dec_hid')
